...
export const strings = {
  ...
  persona: {
    ...
    saving: "Saving...",
    signOutRequired: "Please sign in to save.",
    saveFailed: "Couldn't save this person. Please try again.",
    deleteFailed: "Couldn't delete this person.",
  ...
  chat: {
    ...
    cancel: "Cancel",
    messages: "Messages",
    sendFailure: "Couldn't send your message. Please try again.",
    networkError: "You seem to be offline. Check your connection and try again.",
    streamError: "Something went wrong while getting a reply. Please try again.",
    streamInterrupted: "The reply was cut off. Please try again.",
    emptyReply: "No reply received. Please try again.",
    signedOut: "You're signed out. Please sign in again.",
    sessionExpired: "Session expired. Please sign in again.",
    syncFailed: "Couldn't sync messages. Please refresh.",
    loadOlderFailed: "Couldn't load older messages.",
    saveEditFailed: "Couldn't save your edit. Please try again.",
  ...
  memoryInput: {
    ...
    saveFailed: "Couldn't save this memory. Please try again.",
    updateFailed: "Couldn't update this memory. Please try again.",
    deleteFailed: "Couldn't delete this memory.",
  },
